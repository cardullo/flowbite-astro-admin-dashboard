...
import { e as $$ToggleSwitch } from './kitchen-sink_tPdfWePJ.mjs';

const $$Astro$1 = createAstro("http://localhost:4321");
const $$TermsAndConditions$1 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$TermsAndConditions$1;
...
}, "/Users/francescocardullo/GitHub/flowbite-astro-admin-dashboard/src/modules/TermsAndConditions.astro", void 0);

const $$Astro = createAstro("http://localhost:4321");
const $$TermsAndConditions = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$TermsAndConditions;
  return renderTemplate`${renderComponent($$result, "LayoutStacked", $$LayoutStacked, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "TermsAndConditions", $$TermsAndConditions$1, {})} ` })}`;
}, "/Users/francescocardullo/GitHub/flowbite-astro-admin-dashboard/src/pages/pages/terms-and-conditions.astro", void 0);

const $$file = "/Users/francescocardullo/GitHub/flowbite-astro-admin-dashboard/src/pages/pages/terms-and-conditions.astro";
const $$url = "/pages/terms-and-conditions";

export { $$TermsAndConditions as default, $$file as file, $$url as url };
